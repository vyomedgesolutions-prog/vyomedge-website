...
const caseStudies = [
  { client: 'The SuperC', icon: '⚡', category: 'SEO + Meta Ads', summary: 'From zero to 1.3M impressions and 28.2K clicks through advanced SEO and Meta Ads.', result: '1.3M Impressions', color: '#D300E5' },
  { client: 'Zentrail', icon: '🏔️', category: 'Full Digital Ecosystem', summary: 'Built the entire digital presence from scratch. Achieved 18x ROAS on Meta Ads.', result: '18x ROAS', color: '#7600C4' },
  { client: 'Madhuban Eco Retreat', icon: '🌿', category: 'SEO + Google Ads', summary: 'MERN website with advanced SEO achieving 6.7% CTR and top 5 average position.', result: '6.7% CTR', color: '#4CFFE7' },
  { client: 'Poornam Events', icon: '🎉', category: 'Full Digital Ecosystem', summary: 'Complete ecosystem from logo to MERN site. 456K impressions and CPL of ₹65.6.', result: '456K Impressions', color: '#D300E5' },
  { client: 'Jaiswal Piles Clinic', icon: '🏥', category: 'Full Digital Ecosystem', summary: 'Built full digital presence for medical clinic achieving CPL of ₹46.9 on Meta Ads.', result: '₹46.9 CPL', color: '#7600C4' },
]

const news = [
  { title: 'VyomEdge Achieves 18x ROAS for Zentrail in Latest Meta Campaign', date: 'Mar 2026', tag: 'Achievement' },
  { title: 'Our MERN Stack Framework Now Powers 10+ Business Websites', date: 'Feb 2026', tag: 'Milestone' },
  { title: 'VyomEdge Launches Free Rich Text Editor for Small Businesses', date: 'Jan 2026', tag: 'Product Launch' },
  { title: 'Madhuban Eco Retreat Reaches Top 5 Google Rankings After SEO Overhaul', date: 'Jan 2026', tag: 'Case Study' },
]
            ...
            {caseStudies.map((c, i) => (
              ...
              >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                  style={{ background: `radial-gradient(circle at top left, ${c.color}12, transparent 60%)` }} />
                      ...
                      {b.featuredImage?.url && (
                        <div className="md:w-48 h-40 md:h-auto flex-shrink-0 overflow-hidden">
                          <img
                            ...
                            alt={b.featuredImage.altText || b.title}
